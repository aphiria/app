 ...
 *
 * TODO: Remove this one I've done my PoC tests, and incorporate it back into Aphiria
 */
class UpdatedAuthenticator implements IAuthenticator
{
    /**
     ...
     */
    protected function getSchemes(array|string|null $schemeNames): array
    {
